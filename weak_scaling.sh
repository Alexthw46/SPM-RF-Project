...
srun --nodes=1 --ntasks-per-node=1 --cpus-per-task=2 --time=00:30:00 ./Comparison "./test/covertype.csv" -t 64 -wsp -m 100 -p > covertype_2_threads_wsp.log 2>&1
srun --nodes=1 --ntasks-per-node=1 --cpus-per-task=4 --time=00:20:00 ./Comparison "./test/covertype.csv" -t 64 -wsp -m 100 -p > covertype_4_threads_wsp.log 2>&1
srun --nodes=1 --ntasks-per-node=1 --cpus-per-task=8 --time=00:15:00 ./Comparison "./test/covertype.csv" -t 64 -wsp -m 100 -p > covertype_8_threads_wsp.log 2>&1
srun --nodes=1 --ntasks-per-node=1 --cpus-per-task=16 --time=00:10:00 ./Comparison "./test/covertype.csv" -t 64 -wsp -m 100 -p > covertype_16_threads_wsp.log 2>&1
srun --nodes=1 --ntasks-per-node=1 --cpus-per-task=32 --time=00:10:00 ./Comparison "./test/covertype.csv" -t 64 -wsp -m 100 -p > covertype_32_threads_wsp.log 2>&1
...
# Shared Memory Version with different thread counts, test set size varies according to number of threads
srun --nodes=1 --ntasks-per-node=1 --cpus-per-task=2 --time=00:10:00 ./Comparison "./test/magic04.data" -t 64 -m 100 -wsp -p > magic_2_threads_wsp.log 2>&1
srun --nodes=1 --ntasks-per-node=1 --cpus-per-task=4 --time=00:10:00 ./Comparison "./test/magic04.data" -t 64 -m 100 -wsp -p > magic_4_threads_wsp.log 2>&1
srun --nodes=1 --ntasks-per-node=1 --cpus-per-task=8 --time=00:10:00 ./Comparison "./test/magic04.data" -t 64 -m 100 -wsp -p > magic_8_threads_wsp.log 2>&1
srun --nodes=1 --ntasks-per-node=1 --cpus-per-task=16 --time=00:10:00 ./Comparison "./test/magic04.data" -t 64 -m 100 -wsp -p > magic_16_threads_wsp.log 2>&1
srun --nodes=1 --ntasks-per-node=1 --cpus-per-task=32 --time=00:10:00 ./Comparison "./test/magic04.data" -t 64 -m 100 -wsp -p > magic_32_threads_wsp.log 2>&1